...
static pte_t __ecpt_native_ptep_get_and_clear(pte_t *ptep, unsigned long addr) {
	ecpt_entry_t * e;
	uint64_t * tag_ptr;
					...
					unsigned long addr, pte_t *ptep)
{
	...
	if (ptep != NULL && ptep != &pte_default) {
		...
		return __ecpt_native_ptep_get_and_clear(ptep, addr);
	} 
